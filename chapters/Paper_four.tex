...
An older version of the numerical model (written in C++) has been tested and used for thin film simulations in previous publications~\cite{PhysRevE.100.033313, zitzLatticeBoltzmannSimulations2021}.
...
Some of these schemes can be found in the refs.~\cite{PhysRevFluids.1.073901, diezGlobalModelsMoving2000, beckerComplexDewettingScenarios2003, peschkaSignaturesSlipDewetting2019}.
