...
Instead of directly solving the thin film equation we use a novel method based on a class lattice Boltzmann models~\cite{krugerLatticeBoltzmannMethod2017}, originally developed to simulate shallow water flows~\cite{Salmon:1999:0022-2402:503}.
