...
%The last term on the rhs of (\ref{eq:LBE}) includes the total force $\mathbf{F}_{\mbox{\tiny{tot}}}$ which can be in general the sum of bulk and internal (possibly space and time dependent) contributions. 
...
\begin{figure}
    \centering %Figure without inset is also available, however I personally like this more.
