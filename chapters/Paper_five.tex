...
The details of the method can be found in the App.~\ref{app:two} and in the references~\cite{PhysRevE.100.033313, zitzLatticeBoltzmannSimulations2021}.
...
Performing the limits discussed in ref.~\cite{PhysRevE.100.033313, zitzLatticeBoltzmannSimulations2021}, this system becomes an effective solver for Eq~(\ref{eq:thin_with_marangoni}).
